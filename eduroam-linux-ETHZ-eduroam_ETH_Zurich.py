...
Messages.cat_dir_exisits = "Das Verzeichnis {} existiert bereits; einige Dateien darin könnten überschrieben werden."
Messages.cont = "Weiter?"
Messages.nm_not_supported = "Diese NetworkManager Version wird nicht unterstützt."
Messages.cert_error = "Die Zertifikats-Datei konnte nicht gefunden werden. Dies sieht aus wie ein Fehler des CAT."
Messages.unknown_version = "Unbekannte Version"
Messages.dbus_error = "Ein Problem mit der DBus-Verbindung. Eventuell hilft es, das Programm mit sudo aufzurufen."
Messages.yes = "J"
Messages.no = "N"
...
Messages.save_wpa_conf = "Die Konfiguration von NetworkManager ist fehlgeschlagen, aber es könnte stattdessen eine Konfigurationsdatei für das Programm wpa_supplicant erstellt werden wenn Sie das wünschen. Beachten Sie bitte, dass Ihr Passwort im Klartext in dieser Datei steht."
Messages.save_wpa_confirm = "Datei schreiben"
Messages.wrongUsernameFormat = "Fehler: Ihr Benutzername muss in der Form 'xxx@institutsID' sein; zB 'erika.mustermann@example.net'."
Messages.wrong_realm = "Fehler: Ihr Benutzername muss in der Form 'xxx@{}' sein. Bitte verwenden Sie das korrekte Format."
Messages.wrong_realm_suffix = "Fehler: Ihr Benutzername muss in der Form 'xxx@institutsID' sein und auf '{}' enden. Bitte verwenden Sie das korrekte Format."
Messages.user_cert_missing = "Persönliches Zertifikat nicht gefunden"
Config.instname = "Eidgenössische Technische Hochschule Zürich"
Config.profilename = "eduroam ETH Zurich"
Config.url = "https://www.ethz.ch/services/de/it-services/service-desk.html"
Config.email = "servicedesk@id.ethz.ch"
Config.title = "eduroam CAT"
Config.servers = ['DNS:radius-service.ethz.ch']
Config.ssids = ['eduroam', 'eduroam-5']
Config.del_ssids = []
...
Config.init_info = """Dieses Installationsprogramm wurde für {0} hergestellt.\n\nMehr Informationen und Kommentare:\n\nEMAIL: {1}\nWWW: {2}\n\nDas Installationsprogramm wurde mit Software vom GEANT Projekt erstellt."
"""
Config.init_confirmation = "Dieses Installationsprogramm funktioniert nur für Anwender von {0} in der Benutzergruppe: {1}."
Config.sb_user_file = """"""
